...
/**
 * CSC369 Assignment 4 - exfs command line options parser implementation.
 */
...
static const char* help_str = "\
 ...
 \n\
 Mount exfs image file under mount point directory. Use fusermount(1) to \n\
